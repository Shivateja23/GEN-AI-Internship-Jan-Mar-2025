...
if not api_key:
    st.error("❌ GOOGLE_API_KEY not found. Please set it in Hugging Face Secrets.")
    st.stop()
...
system_message = SystemMessage(
    content=f"You are an AI tutor specialized in Data Science and python. Provide responses based on the user's level: {user_level}."
)
